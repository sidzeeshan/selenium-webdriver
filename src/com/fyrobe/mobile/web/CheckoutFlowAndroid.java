...
public class CheckoutFlowAndroid {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		driver.findElement(By.xpath("//button[contains(@class, 'button') and contains(text(),normalize-space('ADD TO CART'))]")).click(); //changed
		...
		driver.findElement(By.xpath("//*[@id='Email']")).sendKeys("enter email here");
		driver.findElement(By.xpath("//*[@id='next']")).click();
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("Passwd")));
		driver.findElement(By.xpath("//*[@id='Passwd']")).sendKeys("enter password here");
